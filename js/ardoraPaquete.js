...
taboaContidos[0]=new act("Relación Imágenes y Palabras 1","Relación Imágenes y Palabras 1","","<object width='100%' height='420' type='text/html' data='4ADVEM/4ADVEM.htm'></object>",false,"",true,true,true);
taboaContidos[1]=new act("Relación Imágenes y Palabras 2","Relación Imágenes y Palabras 2","","<object width='100%' height='420' type='text/html' data='AD/AD.htm'></object>",false,"",true,true,true);
taboaContidos[2]=new act("Completar Sílabas Computadora","Completar Sílabas Computadora","","<object width='100%' height='420' type='text/html' data='CS/CS.htm'></object>",false,"",true,true,true);
taboaContidos[3]=new act("Ordenar Vocales","Ordenar Vocales","","<object width='100%' height='420' type='text/html' data='4ADVvo/4ADVvo.htm'></object>",false,"",true,true,true);
taboaContidos[4]=new act("Crucigrama de Sonidos de Anima","Crucigrama de Sonidos de Anima","","<object width='100%' height='420' type='text/html' data='Crucigrama/Crucigrama.htm'></object>",false,"",true,true,true);
